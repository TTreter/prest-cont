...
def create_documento(prestacao_id):
    ...
    documento = DocumentoComprovacao(
        ...
        data_documento=datetime.strptime(data['data_documento'], '%Y-%m-%d').date() if data.get('data_documento') else None,
...
def calcular_totais(prestacao_id):
    ...
    # Buscar valores de diária do cargo
